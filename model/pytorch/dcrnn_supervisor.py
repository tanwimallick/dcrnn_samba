...
class DCRNNSupervisor:
    def __init__(self, adj_mx, **kwargs):
        ...
        self._data = utils.load_dataset(self.dataset_dir, self.batch_size, self.test_batch_size)
    ...
    def train(self, patience=50, epochs=100, lr_decay_ratio=0.1, log_every=1, save_model=1,
        ...
        for epoch_num in range(self._epoch_num, self.epochs):
